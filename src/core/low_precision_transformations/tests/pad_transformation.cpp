...
public:
    void SetUp() override {
        ...
        actualFunction = ngraph::builder::subgraph::PadFunction::get(inputShape,
                                                                     testValues.actual.precisionBeforeDequantization,
        ...
        referenceFunction =
            ngraph::builder::subgraph::PadFunction::get(inputShape,
    ...
    static std::string getTestCaseName(testing::TestParamInfo<PadTransformationParams> obj) {
        ...
        result << "_" << toString(testValues.params) << "_" << inputShape << "_" << pads.first << "_" << pads.second
               << "_" << testValues.actual.precisionBeforeDequantization << "_" << testValues.actual.dequantization
               << "_" << testValues.expected.dequantizationBefore;
...
const std::vector<ngraph::PartialShape> inputShapes = {{1, 3, 6, 6}, {4, 3, 6, 6}, {-1, 3, 6, -1}};

const std::pair<std::vector<uint64_t>, std::vector<uint64_t>> padsBySpatialDimensions = {{0, 0, 2, 1}, {0, 0, 1, 2}};
...
const std::vector<ngraph::PartialShape> commonInputShapes = {{4, 3, 6, 6}, {-1, -1, -1, -1}};
...
const std::vector<PadTransformationTestValues> deqWithoutSub = {
    {LayerTransformation::createParamsU8I8(),
     {ngraph::element::u8, {{ngraph::element::f32}, {}, {3.f}}},
     {ngraph::element::u8, {{}, {}, {}}, ngraph::element::u8, {{ngraph::element::f32}, {}, {3.f}}}},
    {LayerTransformation::createParamsI8I8(),
     {ngraph::element::i8, {{ngraph::element::f32}, {}, {3.f}}},
     {ngraph::element::i8, {{}, {}, {}}, ngraph::element::i8, {{ngraph::element::f32}, {}, {3.f}}}},
    {LayerTransformation::createParamsI8I8(),
     {ngraph::element::i8, {{ngraph::element::f32}, {}, {{3.f, 1.f, 2.f}}}},
     {ngraph::element::i8, {{}, {}, {}}, ngraph::element::i8, {{ngraph::element::f32}, {}, {{3.f, 1.f, 2.f}}}}},
    {LayerTransformation::createParamsU8I8(),
     {ngraph::element::u8, {{ngraph::element::f32}, {}, {{3.f, 1.f, 2.f}}}},
     {ngraph::element::u8, {{}, {}, {}}, ngraph::element::u8, {{ngraph::element::f32}, {}, {{3.f, 1.f, 2.f}}}}},
    {LayerTransformation::createParamsU8I8(),
     {ngraph::element::u8, {{}, {}, {}}},
     {ngraph::element::u8, {{}, {}, {}}, ngraph::element::u8, {{}, {}, {}}}},
    {LayerTransformation::createParamsU8I8(),
     {ngraph::element::f32, {{}, {}, {{3.f, 1.f, 2.f}}}},
     {ngraph::element::f32, {{}, {}, {}}, ngraph::element::f32, {{}, {}, {{3.f, 1.f, 2.f}}}}},
...
INSTANTIATE_TEST_SUITE_P(smoke_LPT,
                         PadTransformation,
                         ::testing::Combine(::testing::ValuesIn(commonInputShapes),
...
const std::vector<PadTransformationTestValues> deqWithSub = {
    {LayerTransformation::createParamsU8I8(),
     ...
     {ngraph::element::u8, {{}, {}, {}}, ngraph::element::u8, {{ngraph::element::f32}, {128.f}, {3.f}}}},
    {LayerTransformation::createParamsI8I8(),
     {ngraph::element::i8, {{ngraph::element::f32}, {64.f}, {3.f}}},
     {ngraph::element::i8, {{}, {}, {}}, ngraph::element::i8, {{ngraph::element::f32}, {64.f}, {3.f}}}},
    {LayerTransformation::createParamsI8I8(),
     {ngraph::element::i8, {{ngraph::element::f32}, {{64.f, 32.f, 16.f}}, {{3.f, 1.f, 2.f}}}},
     {ngraph::element::i8,
      {{}, {}, {}},
      ngraph::element::i8,
      {{ngraph::element::f32}, {{64.f, 32.f, 16.f}}, {{3.f, 1.f, 2.f}}}}},
    {LayerTransformation::createParamsU8I8(),
     {ngraph::element::u8, {{ngraph::element::f32}, {{128.f, 64.f, 32.f}}, {{3.f, 1.f, 2.f}}}},
     {ngraph::element::u8,
      {{}, {}, {}},
      ngraph::element::u8,
    ...
    {LayerTransformation::createParamsU8I8(),
     {ngraph::element::u8,
      {{ngraph::element::f32}, {{128.f}, element::undefined, {1, 3, 1, 1}, false, 1ul, element::u8, true}, {3.f}}},
     {ngraph::element::u8,
      {{}, {}, {}},
      ngraph::element::u8,
      {{ngraph::element::f32}, {{128.f}, element::undefined, {1, 3, 1, 1}, false, 1ul, element::u8, true}, {3.f}}}}};
...
const std::vector<PadTransformationTestValues> testValuesForConstantMode = {
    {LayerTransformation::createParamsI8I8(),
     {ngraph::element::i8, {{ngraph::element::f32}, {64.f}, {3.f}}},
     {ngraph::element::i8, {{ngraph::element::f32}, {64.f}, {3.f}}, ngraph::element::f32, {{}, {}, {}}}},
    {LayerTransformation::createParamsI8I8(),
     {ngraph::element::i8, {{ngraph::element::f32}, {{64.f, 32.f, 16.f}}, {{3.f, 1.f, 2.f}}}},
     {ngraph::element::i8,
      {{ngraph::element::f32}, {{64.f, 32.f, 16.f}}, {{3.f, 1.f, 2.f}}},
    ...
    {LayerTransformation::createParamsU8I8(),
     ...
     {ngraph::element::u8,
      ...
      {{ngraph::element::f32},
       {},
       {{1.f, 1.f, 1.f, 2.f, 3.f, 4.f, 5.f, 6.f, 1.f}, ngraph::element::f32, {1, 1, 9, 1}}}}}};
...
const std::vector<PadTransformationTestValues> testValuesForConstantMode2 = {
    {LayerTransformation::createParamsI8I8(),
     {ngraph::element::i8, {{ngraph::element::f32}, {}, {3.f}}},
     {ngraph::element::i8, {{ngraph::element::f32}, {}, {3.f}}, ngraph::element::f32, {{}, {}, {}}}},
    {LayerTransformation::createParamsI8I8(),
     {ngraph::element::i8, {{ngraph::element::f32}, {}, {{3.f, 1.f, 2.f}}}},
     {ngraph::element::i8, {{ngraph::element::f32}, {}, {{3.f, 1.f, 2.f}}}, ngraph::element::f32, {{}, {}, {}}}},
    {LayerTransformation::createParamsU8I8(),
     {ngraph::element::u8, {{ngraph::element::f32}, {}, {{3.f, 1.f, 2.f}}}},
     {ngraph::element::u8, {{ngraph::element::f32}, {}, {{3.f, 1.f, 2.f}}}, ngraph::element::f32, {{}, {}, {}}}}};
...
const std::pair<std::vector<uint64_t>, std::vector<uint64_t>> padsByUniqueDimension = {{0, 0, 2, 0}, {0, 0, 1, 0}};
...
const std::vector<PadTransformationTestValues> testValuesForConstantMode = {
    {LayerTransformation::createParamsI8I8(),
     {ngraph::element::i8,
      {{ngraph::element::f32}, {}, {{3.f, 3.f, 3.f, 2.f, 2.f, 2.f}, ngraph::element::f32, {1, 1, 6, 1}}}},
     {ngraph::element::i8,
      {},
      ngraph::element::i8,
      {{ngraph::element::f32},
...
const std::vector<ngraph::PartialShape> inputShapesWithDynamicRank = {ngraph::PartialShape::dynamic()};
